...
6) Pattern used: • Builder Pattern - building http request object • Strategy Pattern - API/CXS network strategy • Singleton Pattern • Component Pattern

7) Freamwork used: UIKit, search capability 

8) Support iPhone and iPAd with all 4 oriantations
